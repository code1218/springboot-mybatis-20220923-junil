...
function setNewsData(news) {
    ...
    newsfiles.innerHTML = `<a href="/download/news?originFileName=${news.fileList[3].file_origin_name}&tempFileName=${news.fileList[3].file_temp_name}">${news.fileList[0].file_origin_name}</a>`;
}